...
export type ProgressIndicatorWithTextProps = {
  /**
      ...
      return (
        <div className="relative flex flex-col items-end gap-2">
          ...
          <div
            ...
            className="bg-primary_alt absolute -top-2 -translate-x-1/2 -translate-y-full rounded-lg px-3 py-2 shadow-lg ring-1 ring-secondary_alt"
          >
    ...
    case 'bottom-floating':
      return (
        <div className="relative flex flex-col items-end gap-2">
          ...
          <div
            style={{ left: `${percentage}%` }}
            className="bg-primary_alt absolute -bottom-2 -translate-x-1/2 translate-y-full rounded-lg px-3 py-2 shadow-lg ring-1 ring-secondary_alt"
          >
