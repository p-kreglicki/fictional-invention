...
const cardTypes = [
  {
    name: 'Visa',
    pattern: /^4\d{3,}$/, // Visa card numbers start with 4 and are 13 or 16 digits long
    card: 'visa',
    icon: VisaIcon,
  },
  {
    name: 'MasterCard',
    pattern: /^5[1-5]\d{2,}$/, // MasterCard numbers start with 51-55 and are 16 digits long
    card: 'mastercard',
    icon: MastercardIcon,
  },
  {
    name: 'American Express',
    pattern: /^3[47]\d{2,}$/, // American Express numbers start with 34 or 37 and are 15 digits long
    card: 'amex',
    icon: AmexIcon,
  },
  {
    name: 'Discover',
    pattern: /^6(?:011|5\d{2}|4[4-9]\d)\d{12}$/, // Discover card numbers start with 6011 or 65 and are 16 digits long
    card: 'discover',
    icon: DiscoverIcon,
  },
  {
    name: 'UnionPay',
    pattern: /^(62|88)\d{14,17}$/, // UnionPay card numbers start with 62 or 88 and are between 15-19 digits long
    card: 'unionpay',
    icon: UnionPayIcon,
  },
  fallbackCardType,
