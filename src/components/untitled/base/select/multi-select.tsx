...
import { sizes } from '@/components/untitled/base/select/select';
...
} & Omit<AriaComboBoxProps<SelectItemType>, 'children' | 'items'> & RefAttributes<HTMLDivElement>;
    ...
    <div className="relative flex w-full flex-1 flex-row flex-wrap items-center justify-start gap-1.5">
      ...
      <div className={cx('relative flex min-w-[20%] flex-1 flex-row items-center', !isSelectionEmpty && 'ml-0.5', shortcut && 'min-w-[30%]')}>
        <AriaInput
          ...
          className="caret-alpha-black/90 placeholder:text-placeholder disabled:text-disabled disabled:placeholder:text-disabled w-full flex-[1_0_0] appearance-none bg-transparent text-md text-ellipsis text-primary outline-none focus:outline-hidden disabled:cursor-not-allowed"
        />
...
export function MultiSelectTagsValue({
  size,
  shortcut,
  placeholder,
  shortcutClassName,
