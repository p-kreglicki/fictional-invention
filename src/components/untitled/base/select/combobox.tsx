...
import type { CommonProps, SelectItemType } from '@/components/untitled/base/select/select';
...
import { SelectContext, sizes } from '@/components/untitled/base/select/select';
...
} & Omit<AriaComboBoxProps<SelectItemType>, 'children' | 'items'> & RefAttributes<HTMLDivElement> & CommonProps;
        ...
        <>
          ...
          <div className="relative flex w-full items-center gap-2">
            ...
            <AriaInput
              ...
              className="caret-alpha-black/90 placeholder:text-placeholder disabled:text-disabled disabled:placeholder:text-disabled z-10 w-full appearance-none bg-transparent text-md text-transparent focus:outline-hidden disabled:cursor-not-allowed"
            />
          </div>
